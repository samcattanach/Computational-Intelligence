...
public class StartNoGui {
	public static void main(String[] args) {
		...
		Parameters.setHidden(5);      // 5
		Parameters.minGene=-3;      // -3
		Parameters.maxGene=3;      // 3
		Parameters.popSize = 40;      // 40
		Parameters.mutateRate=0.04;      // 0.04
		Parameters.mutateChange=0.1;      // 0.1
